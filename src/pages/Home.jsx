...
//       image:
//         "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Cristiano_Ronaldo_2275_%28cropped%29.jpg/960px-Cristiano_Ronaldo_2275_%28cropped%29.jpg",
//       // "https://drive.google.com/file/d/1ItFBmbNGpm7zgiez1ticaZ_nh1-8VX8R/view",
...
const YaraLanding = () => {
  ...
  // Map API properties to component format with default images
  const properties =
    apiProperties.length > 0
      ? apiProperties.map((prop) => ({
          ...
          size: prop.size,
          type: prop.category === "Real Estate" ? "Real Estate" : "Agriculture",
          price: prop.price,
          image: defaultImages[prop.type] || defaultImages["Residential"],
          features: prop.features || [],
        }))
      : [
          // Fallback data when API is loading or empty
          {
            id: 1,
            title: "Luxury Residential Properties",
            location: "Eko Atlantic, Banana Island, Ikoyi",
