...
//           <p className="mt-4 text-white/60">Loading property details...</p>
//         </div>
//       </div>
//     );
//   }
...
//       <div className="min-h-screen bg-[#0a0e0f] text-white flex items-center justify-center">
//         <div className="text-center">
//           <p className="text-white/60 text-lg mb-4">Property not found</p>
//           <button
//             onClick={() => navigate("/")}
//             className="bg-gradient-gold px-6 py-3 text-sm font-semibold tracking-wide"
//           >
//             Back to Properties
//           </button>
//         </div>
...
//   // Use backend images or fallback to default
//   const propertyImages =
//     apiProperty.images && apiProperty.images.length > 0
//       ? apiProperty.images
...
//     description:
//       apiProperty.description ||
//       `This exceptional ${apiProperty.type.toLowerCase()} property represents a unique investment opportunity in ${apiProperty.location}. Featuring modern architecture and premium finishes, this property is situated in one of Nigeria's most prestigious locations.`,
//   };
...
//                 </div>
//                 <div className="text-lg font-mono text-gold font-semibold">
//                   YARA-{property.id.toString().substring(property.id.length - 4)}
//                 </div>
//               </div>
//             </div>
//           </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-[#0f1415] border border-white/10 rounded-lg p-6">
                ...
                <div className="text-lg font-mono text-gold font-semibold">
                  YARA-
                  {property.id.toString().substring(property.id.length - 4)}
                </div>
              </div>
            </div>
          </div>
